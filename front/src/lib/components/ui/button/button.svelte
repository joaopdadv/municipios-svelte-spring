	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"bg-background text-primary border-primary shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-primary dark:hover:bg-input/50 border-2",
				secondary:
